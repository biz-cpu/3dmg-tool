...
# ═══════════════════════════════════════════════════════════════
    ...
    _components.html('<!DOCTYPE html>\n<html><head><meta charset="utf-8">\n<style>body{margin:0;background:#1e1e1e;}</style>\n</head><body>\n<svg viewBox="0 0 860 1500" width="860" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif">\n<defs>\n  <marker id="a0" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0,8 3,0 6" fill="#888"/></marker>\n  <marker id="ay" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0,8 3,0 6" fill="#00C853"/></marker>\n  <marker id="an" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0,8 3,0 6" fill="#FF3D3D"/></marker>\n</defs>\n<rect width="860" height="1500" fill="#1e1e1e"/>\n\n<!-- START -->\n<rect x="220" y="14" width="420" height="44" rx="22" fill="#CC2222"/>\n<text x="430" y="41" text-anchor="middle" font-size="14" font-weight="bold" fill="#fff">刃先精度が±5cm以内に収まらない</text>\n<line x1="430" y1="58" x2="430" y2="78" stroke="#888" stroke-width="2" marker-end="url(#a0)"/>\n\n<!-- Q1 GNSS FIX cy=116 hw=155 hh=38 -->\n<polygon points="430,78 585,116 430,154 275,116" fill="#252525" stroke="#FFD700" stroke-width="2"/>\n<text x="430" y="110" text-anchor="middle" font-size="12" fill="#FFD700">GNSSステータスは</text>\n<text x="430" y="128" text-anchor="middle" font-size="12" fill="#FFD700">緑色（FIX）ですか？</text>\n<!-- YES: x=800バイパス→Q3右端y=380 -->\n<line x1="585" y1="116" x2="800" y2="116" stroke="#00C853" stroke-width="1.5"/>\n<line x1="800" y1="116" x2="800" y2="380" stroke="#00C853" stroke-width="1.5"/>\n<line x1="800" y1="380" x2="585" y2="380" stroke="#00C853" stroke-width="1.5" marker-end="url(#ay)"/>\n<text x="692" y="108" text-anchor="middle" font-size="11" fill="#00C853">YES</text>\n<!-- NO ↓ -->\n<line x1="430" y1="154" x2="430" y2="178" stroke="#FF3D3D" stroke-width="1.5" marker-end="url(#an)"/>\n<text x="446" y="171" font-size="11" fill="#FF3D3D">NO</text>\n\n<!-- Q2 補正 cy=228 hw=145 hh=50 -->\n<polygon points="430,178 575,228 430,278 285,228" fill="#252525" stroke="#FFD700" stroke-width="2"/>\n<text x="430" y="222" text-anchor="middle" font-size="12" fill="#FFD700">補正情報は</text>\n<text x="430" y="240" text-anchor="middle" font-size="12" fill="#FFD700">受信できていますか？</text>\n<!-- YES → FIX不可 -->\n<line x1="575" y1="228" x2="608" y2="228" stroke="#00C853" stroke-width="1.5" marker-end="url(#ay)"/>\n<text x="591" y="220" text-anchor="middle" font-size="11" fill="#00C853">YES</text>\n<rect x="610" y="206" width="175" height="50" rx="6" fill="#550000" stroke="#FF3D3D" stroke-width="1.5"/>\n<text x="697" y="227" text-anchor="middle" font-size="12" fill="#FF3D3D" font-weight="bold">📌 FIX不可</text>\n<text x="697" y="246" text-anchor="middle" font-size="11" fill="#FF3D3D">上空・環境・障害物確認</text>\n<!-- NO ↓ 補正なし -->\n<line x1="430" y1="278" x2="430" y2="296" stroke="#FF3D3D" stroke-width="1.5" marker-end="url(#an)"/>\n<text x="446" y="290" font-size="11" fill="#FF3D3D">NO</text>\n<rect x="220" y="298" width="420" height="52" rx="6" fill="#550000" stroke="#FF3D3D" stroke-width="1.5"/>\n<text x="430" y="321" text-anchor="middle" font-size="12" fill="#FF3D3D" font-weight="bold">📌 補正情報が届いていない</text>\n<text x="430" y="339" text-anchor="middle" font-size="11" fill="#FF3D3D">SIM / Ntrip / 固定局 / 無線機を確認</text>\n\n<!-- Q3 一定? cy=380 hw=155 hh=38 -->\n<polygon points="430,342 585,380 430,418 275,380" fill="#252525" stroke="#FFD700" stroke-width="2"/>\n<text x="430" y="374" text-anchor="middle" font-size="12" fill="#FFD700">誤差の方向・大きさが</text>\n<text x="430" y="392" text-anchor="middle" font-size="12" fill="#FFD700">姿勢によらず一定ですか？</text>\n<!-- YES 点線 → Q4(cy=940) -->\n<line x1="430" y1="418" x2="430" y2="902" stroke="#00C853" stroke-width="1.5" stroke-dasharray="7,5"/>\n<text x="448" y="440" font-size="11" fill="#00C853">YES↓</text>\n<!-- NO: 275→90→down→Q_RAND左端(45,480) -->\n<line x1="275" y1="380" x2="90"  y2="380" stroke="#FF3D3D" stroke-width="1.5"/>\n<line x1="90"  y1="380" x2="90"  y2="480" stroke="#FF3D3D" stroke-width="1.5"/>\n<line x1="90"  y1="480" x2="45"  y2="480" stroke="#FF3D3D" stroke-width="1.5" marker-end="url(#an)"/>\n<text x="178" y="372" text-anchor="middle" font-size="11" fill="#FF3D3D">NO</text>\n\n<!-- 左ブランチ cx=150 -->\n<text x="150" y="444" text-anchor="middle" font-size="10" fill="#666">▼ 姿勢依存ルート</text>\n\n<!-- Q_RAND cy=480 hw=105 hh=30 -->\n<polygon points="150,450 255,480 150,510 45,480" fill="#252525" stroke="#FFD700" stroke-width="1.5"/>\n<text x="150" y="474" text-anchor="middle" font-size="11" fill="#FFD700">誤差の方向が</text>\n<text x="150" y="490" text-anchor="middle" font-size="11" fill="#FFD700">バラバラですか？</text>\n<!-- RAND NO: x=14→下→PJリーフ(y=808) -->\n<line x1="45"  y1="480" x2="14"  y2="480" stroke="#FF3D3D" stroke-width="1.5"/>\n<line x1="14"  y1="480" x2="14"  y2="822" stroke="#FF3D3D" stroke-width="1.5"/>\n<line x1="14"  y1="822" x2="46"  y2="822" stroke="#FF3D3D" stroke-width="1.5" marker-end="url(#an)"/>\n<text x="28"   y="472" font-size="11" fill="#FF3D3D">NO</text>\n<!-- RAND YES ↓ -->\n<line x1="150" y1="510" x2="150" y2="540" stroke="#00C853" stroke-width="1.5" marker-end="url(#ay)"/>\n<text x="166" y="532" font-size="11" fill="#00C853">YES</text>\n\n<!-- Q_IMU cy=580 hw=105 hh=30 -->\n<polygon points="150,550 255,580 150,610 45,580" fill="#252525" stroke="#FFD700" stroke-width="1.5"/>\n<text x="150" y="574" text-anchor="middle" font-size="11" fill="#FFD700">作業機の追従は</text>\n<text x="150" y="590" text-anchor="middle" font-size="11" fill="#FFD700">正確ですか？</text>\n<!-- IMU NO ↓ -->\n<line x1="150" y1="610" x2="150" y2="638" stroke="#FF3D3D" stroke-width="1.5" marker-end="url(#an)"/>\n<text x="166" y="630" font-size="11" fill="#FF3D3D">NO</text>\n<rect x="46"  y="640" width="208" height="50" rx="6" fill="#550000" stroke="#FF3D3D" stroke-width="1.5"/>\n<text x="150" y="661" text-anchor="middle" font-size="12" fill="#FF3D3D" font-weight="bold">📌 IMUセンサ不良</text>\n<text x="150" y="679" text-anchor="middle" font-size="11" fill="#FF3D3D">取付・ハーネス確認</text>\n<!-- IMU YES → マルチパス (点線x=430の右 x=462-670) -->\n<line x1="255" y1="580" x2="462" y2="580" stroke="#00C853" stroke-width="1.5" marker-end="url(#ay)"/>\n<text x="358" y="572" text-anchor="middle" font-size="11" fill="#00C853">YES</text>\n<rect x="464" y="558" width="210" height="50" rx="6" fill="#443300" stroke="#FF9800" stroke-width="1.5"/>\n<text x="569" y="578" text-anchor="middle" font-size="12" fill="#FF9800" font-weight="bold">📌 マルチパス・環境ノイズ</text>\n<text x="569" y="596" text-anchor="middle" font-size="11" fill="#FF9800">場所移動・PDOP確認</text>\n\n<!-- PJリーフ RAND NO到達 y=806-858 -->\n<rect x="48"  y="806" width="240" height="52" rx="6" fill="#443300" stroke="#FF9800" stroke-width="1.5"/>\n<text x="168" y="829" text-anchor="middle" font-size="12" fill="#FF9800" font-weight="bold">📌 PJファイル・設定確認</text>\n<text x="168" y="847" text-anchor="middle" font-size="11" fill="#FF9800">ローカライゼーション再実施</text>\n\n<!-- 区切り -->\n<line x1="20" y1="878" x2="840" y2="878" stroke="#333" stroke-width="1" stroke-dasharray="5,5"/>\n<text x="430" y="894" text-anchor="middle" font-size="10" fill="#555">── 系統誤差ルート（姿勢によらず一定）──</text>\n\n<!-- Q4 Z方向 cy=940 hw=155 hh=38 -->\n<polygon points="430,902 585,940 430,978 275,940" fill="#252525" stroke="#FFD700" stroke-width="2"/>\n<text x="430" y="934" text-anchor="middle" font-size="12" fill="#FFD700">Z方向（高さ）に</text>\n<text x="430" y="952" text-anchor="middle" font-size="12" fill="#FFD700">系統誤差がありますか？</text>\n<!-- YES ↓ -->\n<line x1="430" y1="978" x2="430" y2="1004" stroke="#00C853" stroke-width="1.5" marker-end="url(#ay)"/>\n<text x="446" y="996" font-size="11" fill="#00C853">YES</text>\n<!-- NO: x=800バイパス→Q6上端(1194) -->\n<line x1="585" y1="940"  x2="800" y2="940"  stroke="#FF3D3D" stroke-width="1.5"/>\n<line x1="800" y1="940"  x2="800" y2="1194" stroke="#FF3D3D" stroke-width="1.5"/>\n<line x1="800" y1="1194" x2="585" y2="1194" stroke="#FF3D3D" stroke-width="1.5" marker-end="url(#an)"/>\n<text x="692" y="932" text-anchor="middle" font-size="11" fill="#FF3D3D">NO</text>\n\n<!-- Q5 バケット cy=1054 hw=148 hh=40 -->\n<polygon points="430,1014 578,1054 430,1094 282,1054" fill="#252525" stroke="#FFD700" stroke-width="1.5"/>\n<text x="430" y="1048" text-anchor="middle" font-size="12" fill="#FFD700">バケットファイル・</text>\n<text x="430" y="1066" text-anchor="middle" font-size="12" fill="#FFD700">ツース長は正確ですか？</text>\n<!-- YES → GNSS高さ -->\n<line x1="578" y1="1054" x2="608" y2="1054" stroke="#00C853" stroke-width="1.5" marker-end="url(#ay)"/>\n<text x="593" y="1046" text-anchor="middle" font-size="11" fill="#00C853">YES</text>\n<rect x="610" y="1032" width="175" height="50" rx="6" fill="#443300" stroke="#FF9800" stroke-width="1.5"/>\n<text x="697" y="1053" text-anchor="middle" font-size="12" fill="#FF9800" font-weight="bold">📌 GNSS高さ精度</text>\n<text x="697" y="1072" text-anchor="middle" font-size="11" fill="#FF9800">垂直RMS・PJ確認</text>\n<!-- NO ↓ バケット -->\n<line x1="430" y1="1094" x2="430" y2="1112" stroke="#FF3D3D" stroke-width="1.5" marker-end="url(#an)"/>\n<text x="446" y="1106" font-size="11" fill="#FF3D3D">NO</text>\n<rect x="220" y="1114" width="420" height="52" rx="6" fill="#550000" stroke="#FF3D3D" stroke-width="1.5"/>\n<text x="430" y="1137" text-anchor="middle" font-size="12" fill="#FF3D3D" font-weight="bold">📌 バケット設定誤り</text>\n<text x="430" y="1155" text-anchor="middle" font-size="11" fill="#FF3D3D">ツース長・寸法を修正</text>\n\n<!-- Q6 N/E cy=1232 hw=155 hh=38 -->\n<polygon points="430,1194 585,1232 430,1270 275,1232" fill="#252525" stroke="#FFD700" stroke-width="2"/>\n<text x="430" y="1226" text-anchor="middle" font-size="12" fill="#FFD700">N/E方向（前後左右）に</text>\n<text x="430" y="1244" text-anchor="middle" font-size="12" fill="#FFD700">系統誤差がありますか？</text>\n<!-- YES ↓ -->\n<line x1="430" y1="1270" x2="430" y2="1296" stroke="#00C853" stroke-width="1.5" marker-end="url(#ay)"/>\n<text x="446" y="1288" font-size="11" fill="#00C853">YES</text>\n<!-- NO → PJ誤り (右リーフ x=610-785 y=1212-1262) -->\n<line x1="585" y1="1232" x2="608" y2="1232" stroke="#FF3D3D" stroke-width="1.5" marker-end="url(#an)"/>\n<text x="596" y="1224" font-size="11" fill="#FF3D3D">NO</text>\n<rect x="610" y="1210" width="178" height="52" rx="6" fill="#443300" stroke="#FF9800" stroke-width="1.5"/>\n<text x="699" y="1233" text-anchor="middle" font-size="12" fill="#FF9800" font-weight="bold">📌 PJファイル誤り</text>\n<text x="699" y="1251" text-anchor="middle" font-size="11" fill="#FF9800">基準点・ローカライゼーション</text>\n\n<!-- Q7 アンテナ cy=1350 hw=148 hh=40 -->\n<polygon points="430,1310 578,1350 430,1390 282,1350" fill="#252525" stroke="#FFD700" stroke-width="1.5"/>\n<text x="430" y="1344" text-anchor="middle" font-size="12" fill="#FFD700">アンテナ取付位置・向きは</text>\n<text x="430" y="1362" text-anchor="middle" font-size="12" fill="#FFD700">仕様通りですか？</text>\n<!-- YES → PJ誤り -->\n<line x1="578" y1="1350" x2="608" y2="1350" stroke="#00C853" stroke-width="1.5" marker-end="url(#ay)"/>\n<text x="593" y="1342" text-anchor="middle" font-size="11" fill="#00C853">YES</text>\n<rect x="610" y="1328" width="178" height="52" rx="6" fill="#443300" stroke="#FF9800" stroke-width="1.5"/>\n<text x="699" y="1351" text-anchor="middle" font-size="12" fill="#FF9800" font-weight="bold">📌 PJファイル誤り</text>\n<text x="699" y="1369" text-anchor="middle" font-size="11" fill="#FF9800">基準点・ローカライゼーション</text>\n<!-- NO ↓ アンテナ不良 -->\n<line x1="430" y1="1390" x2="430" y2="1408" stroke="#FF3D3D" stroke-width="1.5" marker-end="url(#an)"/>\n<text x="446" y="1402" font-size="11" fill="#FF3D3D">NO</text>\n<rect x="220" y="1410" width="420" height="52" rx="6" fill="#550000" stroke="#FF3D3D" stroke-width="1.5"/>\n<text x="430" y="1433" text-anchor="middle" font-size="12" fill="#FF3D3D" font-weight="bold">📌 アンテナ取付不良</text>\n<text x="430" y="1451" text-anchor="middle" font-size="11" fill="#FF3D3D">位置・向き・ガタ確認</text>\n\n<!-- 凡例 -->\n<rect x="240" y="1476" width="12" height="12" fill="#FFD700"/>\n<text x="258" y="1487" font-size="11" fill="#aaa">判断分岐</text>\n<rect x="358" y="1476" width="12" height="12" fill="#FF3D3D" opacity="0.8"/>\n<text x="376" y="1487" font-size="11" fill="#aaa">原因（赤）</text>\n<rect x="476" y="1476" width="12" height="12" fill="#FF9800" opacity="0.8"/>\n<text x="494" y="1487" font-size="11" fill="#aaa">原因（橙）</text>\n</svg>\n</body></html>', height=1520, scrolling=True)
