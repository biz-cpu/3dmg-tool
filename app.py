...
# ═══════════════════════════════════════════════════════════════
    ...
    _components.html('<!DOCTYPE html>\n<html><head><meta charset="utf-8">\n<style>\n  body { margin:0; background:#1e1e1e; display:flex; justify-content:center; }\n</style>\n</head><body>\n<svg viewBox="0 0 1000 1510" width="1000" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif">\n<defs>\n  <marker id="a0" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0,8 3,0 6" fill="#888"/></marker>\n  <marker id="ay" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0,8 3,0 6" fill="#00C853"/></marker>\n  <marker id="an" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><polygon points="0 0,8 3,0 6" fill="#FF3D3D"/></marker>\n</defs>\n<rect width="1000" height="1510" fill="#1e1e1e"/>\n\n<!-- START -->\n<rect x="300" y="14" width="400" height="44" rx="22" fill="#CC2222"/>\n<text x="500" y="41" text-anchor="middle" font-size="14" font-weight="bold" fill="#fff">刃先精度が±5cm以内に収まらない</text>\n<line x1="500" y1="58" x2="500" y2="80" stroke="#888" stroke-width="2" marker-end="url(#a0)"/>\n\n<!-- Q1 GNSS FIX cy=118 hw=160 hh=38 -->\n<polygon points="500,80 660,118 500,156 340,118" fill="#252525" stroke="#FFD700" stroke-width="2"/>\n<text x="500" y="112" text-anchor="middle" font-size="12" fill="#FFD700">GNSSステータスは</text>\n<text x="500" y="130" text-anchor="middle" font-size="12" fill="#FFD700">緑色（FIX）ですか？</text>\n<!-- YES: 右 x=920 → Q3右端(660,400) -->\n<line x1="660" y1="118" x2="920" y2="118" stroke="#00C853" stroke-width="1.5"/>\n<line x1="920" y1="118" x2="920" y2="400" stroke="#00C853" stroke-width="1.5"/>\n<line x1="920" y1="400" x2="660" y2="400" stroke="#00C853" stroke-width="1.5" marker-end="url(#ay)"/>\n<text x="790" y="110" text-anchor="middle" font-size="11" fill="#00C853">YES</text>\n<!-- NO ↓ -->\n<line x1="500" y1="156" x2="500" y2="180" stroke="#FF3D3D" stroke-width="1.5" marker-end="url(#an)"/>\n<text x="516" y="173" font-size="11" fill="#FF3D3D">NO</text>\n\n<!-- Q2 補正 cy=230 hw=150 hh=50 -->\n<polygon points="500,180 650,230 500,280 350,230" fill="#252525" stroke="#FFD700" stroke-width="2"/>\n<text x="500" y="224" text-anchor="middle" font-size="12" fill="#FFD700">補正情報は</text>\n<text x="500" y="242" text-anchor="middle" font-size="12" fill="#FFD700">受信できていますか？</text>\n<!-- YES → FIX不可 -->\n<line x1="650" y1="230" x2="704" y2="230" stroke="#00C853" stroke-width="1.5" marker-end="url(#ay)"/>\n<text x="677" y="222" text-anchor="middle" font-size="11" fill="#00C853">YES</text>\n<rect x="706" y="208" width="176" height="50" rx="6" fill="#550000" stroke="#FF3D3D" stroke-width="1.5"/>\n<text x="794" y="229" text-anchor="middle" font-size="12" fill="#FF3D3D" font-weight="bold">📌 FIX不可</text>\n<text x="794" y="248" text-anchor="middle" font-size="11" fill="#FF3D3D">上空・環境・障害物確認</text>\n<!-- NO ↓ 補正なし -->\n<line x1="500" y1="280" x2="500" y2="298" stroke="#FF3D3D" stroke-width="1.5" marker-end="url(#an)"/>\n<text x="516" y="292" font-size="11" fill="#FF3D3D">NO</text>\n<rect x="290" y="300" width="420" height="52" rx="6" fill="#550000" stroke="#FF3D3D" stroke-width="1.5"/>\n<text x="500" y="323" text-anchor="middle" font-size="12" fill="#FF3D3D" font-weight="bold">📌 補正情報が届いていない</text>\n<text x="500" y="341" text-anchor="middle" font-size="11" fill="#FF3D3D">SIM / Ntrip / 固定局 / 無線機を確認</text>\n\n<!-- Q3 一定? cy=400 hw=160 hh=38 -->\n<polygon points="500,362 660,400 500,438 340,400" fill="#252525" stroke="#FFD700" stroke-width="2"/>\n<text x="500" y="394" text-anchor="middle" font-size="12" fill="#FFD700">誤差の方向・大きさが</text>\n<text x="500" y="412" text-anchor="middle" font-size="12" fill="#FFD700">姿勢によらず一定ですか？</text>\n<!-- YES: 点線 → Q4(cy=950) -->\n<line x1="500" y1="438" x2="500" y2="912" stroke="#00C853" stroke-width="1.5" stroke-dasharray="7,5"/>\n<text x="518" y="458" font-size="11" fill="#00C853">YES↓</text>\n<!-- NO: 340→200→下→Q_RAND左端(95,490) -->\n<line x1="340" y1="400" x2="200" y2="400" stroke="#FF3D3D" stroke-width="1.5"/>\n<line x1="200" y1="400" x2="200" y2="462" stroke="#FF3D3D" stroke-width="1.5" marker-end="url(#an)"/>\n<text x="266" y="392" text-anchor="middle" font-size="11" fill="#FF3D3D">NO</text>\n\n<!-- 左ブランチ cx=200 -->\n<text x="200" y="460" text-anchor="middle" font-size="10" fill="#666">▼ 姿勢依存ルート</text>\n\n<!-- Q_RAND cy=500 hw=105 hh=30 -->\n<polygon points="200,470 305,500 200,530 95,500" fill="#252525" stroke="#FFD700" stroke-width="1.5"/>\n<text x="200" y="494" text-anchor="middle" font-size="11" fill="#FFD700">誤差の方向が</text>\n<text x="200" y="510" text-anchor="middle" font-size="11" fill="#FFD700">バラバラですか？</text>\n<!-- RAND NO: x=60→下→PJリーフ(y=826) -->\n<line x1="95"  y1="500" x2="60"  y2="500" stroke="#FF3D3D" stroke-width="1.5"/>\n<line x1="60"  y1="500" x2="60"  y2="840" stroke="#FF3D3D" stroke-width="1.5"/>\n<line x1="60"  y1="840" x2="96"  y2="840" stroke="#FF3D3D" stroke-width="1.5" marker-end="url(#an)"/>\n<text x="76"   y="492" font-size="11" fill="#FF3D3D">NO</text>\n<!-- RAND YES ↓ -->\n<line x1="200" y1="530" x2="200" y2="558" stroke="#00C853" stroke-width="1.5" marker-end="url(#ay)"/>\n<text x="216" y="550" font-size="11" fill="#00C853">YES</text>\n\n<!-- Q_IMU cy=596 hw=105 hh=30 -->\n<polygon points="200,566 305,596 200,626 95,596" fill="#252525" stroke="#FFD700" stroke-width="1.5"/>\n<text x="200" y="590" text-anchor="middle" font-size="11" fill="#FFD700">作業機の追従は</text>\n<text x="200" y="606" text-anchor="middle" font-size="11" fill="#FFD700">正確ですか？</text>\n<!-- IMU NO ↓ -->\n<line x1="200" y1="626" x2="200" y2="652" stroke="#FF3D3D" stroke-width="1.5" marker-end="url(#an)"/>\n<text x="216" y="644" font-size="11" fill="#FF3D3D">NO</text>\n<rect x="96"  y="654" width="208" height="50" rx="6" fill="#550000" stroke="#FF3D3D" stroke-width="1.5"/>\n<text x="200" y="675" text-anchor="middle" font-size="12" fill="#FF3D3D" font-weight="bold">📌 IMUセンサ不良</text>\n<text x="200" y="693" text-anchor="middle" font-size="11" fill="#FF3D3D">取付・ハーネス確認</text>\n<!-- IMU YES → マルチパス (点線x=500より右 x=530-740) -->\n<line x1="305" y1="596" x2="530" y2="596" stroke="#00C853" stroke-width="1.5" marker-end="url(#ay)"/>\n<text x="417" y="588" text-anchor="middle" font-size="11" fill="#00C853">YES</text>\n<rect x="532" y="574" width="210" height="50" rx="6" fill="#443300" stroke="#FF9800" stroke-width="1.5"/>\n<text x="637" y="594" text-anchor="middle" font-size="12" fill="#FF9800" font-weight="bold">📌 マルチパス・環境ノイズ</text>\n<text x="637" y="612" text-anchor="middle" font-size="11" fill="#FF9800">場所移動・PDOP確認</text>\n\n<!-- PJリーフ RAND NO到達 y=822-874 -->\n<rect x="98"  y="822" width="240" height="52" rx="6" fill="#443300" stroke="#FF9800" stroke-width="1.5"/>\n<text x="218" y="845" text-anchor="middle" font-size="12" fill="#FF9800" font-weight="bold">📌 PJファイル・設定確認</text>\n<text x="218" y="863" text-anchor="middle" font-size="11" fill="#FF9800">ローカライゼーション再実施</text>\n\n<!-- 区切り -->\n<line x1="20" y1="896" x2="980" y2="896" stroke="#333" stroke-width="1" stroke-dasharray="5,5"/>\n<text x="500" y="912" text-anchor="middle" font-size="10" fill="#555">── 系統誤差ルート（姿勢によらず一定）──</text>\n\n<!-- Q4 Z方向 cy=962 hw=160 hh=38 -->\n<polygon points="500,924 660,962 500,1000 340,962" fill="#252525" stroke="#FFD700" stroke-width="2"/>\n<text x="500" y="956" text-anchor="middle" font-size="12" fill="#FFD700">Z方向（高さ）に</text>\n<text x="500" y="974" text-anchor="middle" font-size="12" fill="#FFD700">系統誤差がありますか？</text>\n<!-- YES ↓ -->\n<line x1="500" y1="1000" x2="500" y2="1026" stroke="#00C853" stroke-width="1.5" marker-end="url(#ay)"/>\n<text x="516" y="1018" font-size="11" fill="#00C853">YES</text>\n<!-- NO: 左バイパス x=170 → Q6左端(340,1240) -->\n<line x1="340" y1="962"  x2="170" y2="962"  stroke="#FF3D3D" stroke-width="1.5"/>\n<line x1="170" y1="962"  x2="170" y2="1240" stroke="#FF3D3D" stroke-width="1.5"/>\n<line x1="170" y1="1240" x2="340" y2="1240" stroke="#FF3D3D" stroke-width="1.5" marker-end="url(#an)"/>\n<text x="250" y="954" text-anchor="middle" font-size="11" fill="#FF3D3D">NO</text>\n\n<!-- Q5 バケット cy=1074 hw=150 hh=40 -->\n<polygon points="500,1036 650,1074 500,1112 350,1074" fill="#252525" stroke="#FFD700" stroke-width="1.5"/>\n<text x="500" y="1068" text-anchor="middle" font-size="12" fill="#FFD700">バケットファイル・</text>\n<text x="500" y="1086" text-anchor="middle" font-size="12" fill="#FFD700">ツース長は正確ですか？</text>\n<!-- YES → GNSS高さ -->\n<line x1="650" y1="1074" x2="704" y2="1074" stroke="#00C853" stroke-width="1.5" marker-end="url(#ay)"/>\n<text x="677" y="1066" text-anchor="middle" font-size="11" fill="#00C853">YES</text>\n<rect x="706" y="1052" width="176" height="50" rx="6" fill="#443300" stroke="#FF9800" stroke-width="1.5"/>\n<text x="794" y="1073" text-anchor="middle" font-size="12" fill="#FF9800" font-weight="bold">📌 GNSS高さ精度</text>\n<text x="794" y="1092" text-anchor="middle" font-size="11" fill="#FF9800">垂直RMS・PJ確認</text>\n<!-- NO ↓ バケット設定誤り -->\n<line x1="500" y1="1112" x2="500" y2="1130" stroke="#FF3D3D" stroke-width="1.5" marker-end="url(#an)"/>\n<text x="516" y="1124" font-size="11" fill="#FF3D3D">NO</text>\n<rect x="290" y="1132" width="420" height="52" rx="6" fill="#550000" stroke="#FF3D3D" stroke-width="1.5"/>\n<text x="500" y="1155" text-anchor="middle" font-size="12" fill="#FF3D3D" font-weight="bold">📌 バケット設定誤り</text>\n<text x="500" y="1173" text-anchor="middle" font-size="11" fill="#FF3D3D">ツース長・寸法を修正</text>\n\n<!-- Q6 N/E cy=1240 hw=160 hh=38 -->\n<polygon points="500,1202 660,1240 500,1278 340,1240" fill="#252525" stroke="#FFD700" stroke-width="2"/>\n<text x="500" y="1234" text-anchor="middle" font-size="12" fill="#FFD700">N/E方向（前後左右）に</text>\n<text x="500" y="1252" text-anchor="middle" font-size="12" fill="#FFD700">系統誤差がありますか？</text>\n<!-- YES ↓ -->\n<line x1="500" y1="1278" x2="500" y2="1304" stroke="#00C853" stroke-width="1.5" marker-end="url(#ay)"/>\n<text x="516" y="1296" font-size="11" fill="#00C853">YES</text>\n<!-- NO → PJ誤り -->\n<line x1="660" y1="1240" x2="704" y2="1240" stroke="#FF3D3D" stroke-width="1.5" marker-end="url(#an)"/>\n<text x="682" y="1232" text-anchor="middle" font-size="11" fill="#FF3D3D">NO</text>\n<rect x="706" y="1218" width="176" height="50" rx="6" fill="#443300" stroke="#FF9800" stroke-width="1.5"/>\n<text x="794" y="1239" text-anchor="middle" font-size="12" fill="#FF9800" font-weight="bold">📌 PJファイル誤り</text>\n<text x="794" y="1258" text-anchor="middle" font-size="11" fill="#FF9800">基準点・ローカライゼーション</text>\n\n<!-- Q7 アンテナ cy=1358 hw=150 hh=40 -->\n<polygon points="500,1318 650,1358 500,1398 350,1358" fill="#252525" stroke="#FFD700" stroke-width="1.5"/>\n<text x="500" y="1352" text-anchor="middle" font-size="12" fill="#FFD700">アンテナ取付位置・向きは</text>\n<text x="500" y="1370" text-anchor="middle" font-size="12" fill="#FFD700">仕様通りですか？</text>\n<!-- YES → PJ誤り -->\n<line x1="650" y1="1358" x2="704" y2="1358" stroke="#00C853" stroke-width="1.5" marker-end="url(#ay)"/>\n<text x="677" y="1350" text-anchor="middle" font-size="11" fill="#00C853">YES</text>\n<rect x="706" y="1336" width="176" height="50" rx="6" fill="#443300" stroke="#FF9800" stroke-width="1.5"/>\n<text x="794" y="1357" text-anchor="middle" font-size="12" fill="#FF9800" font-weight="bold">📌 PJファイル誤り</text>\n<text x="794" y="1376" text-anchor="middle" font-size="11" fill="#FF9800">基準点・ローカライゼーション</text>\n<!-- NO ↓ アンテナ不良 -->\n<line x1="500" y1="1398" x2="500" y2="1416" stroke="#FF3D3D" stroke-width="1.5" marker-end="url(#an)"/>\n<text x="516" y="1410" font-size="11" fill="#FF3D3D">NO</text>\n<rect x="290" y="1418" width="420" height="52" rx="6" fill="#550000" stroke="#FF3D3D" stroke-width="1.5"/>\n<text x="500" y="1441" text-anchor="middle" font-size="12" fill="#FF3D3D" font-weight="bold">📌 アンテナ取付不良</text>\n<text x="500" y="1459" text-anchor="middle" font-size="11" fill="#FF3D3D">位置・向き・ガタ確認</text>\n\n<!-- 凡例 -->\n<rect x="310" y="1484" width="12" height="12" fill="#FFD700"/>\n<text x="328" y="1495" font-size="11" fill="#aaa">判断分岐</text>\n<rect x="428" y="1484" width="12" height="12" fill="#FF3D3D" opacity="0.8"/>\n<text x="446" y="1495" font-size="11" fill="#aaa">原因（赤）</text>\n<rect x="546" y="1484" width="12" height="12" fill="#FF9800" opacity="0.8"/>\n<text x="564" y="1495" font-size="11" fill="#aaa">原因（橙）</text>\n</svg>\n</body></html>', height=1540, scrolling=True)
